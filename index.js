...
Description: Creates a list of things to do on the weekends
Date: 02/13/25
*/

//jshint esversion:6

/* for this activity I used AI to add jest test suite and verify if server is running
...
- Searched for html code for hibiscus emoji
*/
...
app.get("/weekend", function (req, res) {
  // Fixed typo here
  res.render("list", {
    listTitle: "Weekend Things To Do List",
